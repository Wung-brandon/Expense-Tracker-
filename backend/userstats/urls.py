...
from .views import ExpenseSummaryStatsView, MonthlyExpensesView, CurrentDayExpensesView, DayOfWeekExpensesView, WeeklySummaryStatsView, IncomeSummaryStatsView, IncomeVsExpenseStatsView, TotalBalanceSummaryView, ExpenseVsBudgetStatsView, MonthlySummaryStatsView
...
urlpatterns = [
    ...
    path("day-summary/", DayOfWeekExpensesView.as_view(), name='day-summary'),
    path("current-day/", CurrentDayExpensesView.as_view(), name='day-summary'),
