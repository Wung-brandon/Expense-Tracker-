...
from .views import SignUpView, MyTokenObtainPairView, ListCreateUserProfileView, RetrieveUpdateUserProfileView, GetUserView, ForgotPasswordView, EmailVerificationView, ResetPasswordView, ResendVerificationEmailView
